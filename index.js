...
const questions = ["What is the title of this project?", "What does this project do?", "What are the installation instructions?  Any needed dependencies?", "What are the github usernames of the contributors?", "What are the instructions to test this project?", "How is this to be used?"
];
...
async function init() {
  try {
    ...
    writeFile("sampleREADME.md", generateMarkdown(data))
